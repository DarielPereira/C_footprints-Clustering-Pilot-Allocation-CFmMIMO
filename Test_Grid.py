...
np.savez(f'./GRAPHs/VARIABLES_SAVED/Grid_mediumAPs_dotProduct',
...
np.savez(f'./GRAPHs/VARIABLES_SAVED/Grid_mediumAPs_NMSE',
                 grid_product=Grid_NMSE, UE_position=UE_fixed, AP_positions = APpositions)
